...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  7 15:37:14 2021
...
__all__ = ['QuantizableResNet', 'resnet18', 'resnet50', 'resnet152',
           'resnext101_32x8d']
...
def resnet152(pretrained=False, progress=True, quantize=False, **kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        ...
        quantize (bool): If True, return a quantized version of the model
    """
    return _resnet('resnet152', QuantizableBottleneck, [3, 8, 36, 3], pretrained, progress, quantize,
                   **kwargs)
